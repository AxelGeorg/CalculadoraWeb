...
@Component({                //gera um tag html
  selector: 'app-calculadora', //tag html
  templateUrl: './calculadora.component.html',
  styleUrls: ['./calculadora.component.css']
})
export class CalculadoraComponent implements OnInit { //class com implementação de uma inteface(regra)
  ...
  //ciclos de vida, esse na inicialização
  ngOnInit() {
    this.limpar();
  }
